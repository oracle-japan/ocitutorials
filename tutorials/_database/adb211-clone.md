...
<!--
上記の情報をクローン・タイプ別にまとめると次のようになります：

<table>
	<tr>
		<th bgcolor="#c74634">
      <div style="color:white; text-align: center"><b>クローン・タイプ</b></div>
    </th>
		<th bgcolor="#c74634">
      <div style="color:white; text-align: center"><b>ソースの選択</b></div>
    </th>
		<th bgcolor="#c74634">
      <div style="color:white; text-align: center"><b>クローン先の構成</b></div>
    </th>
	</tr>
	<tr>
		<td><div style="color:#c74634"><b>フル・クローン</b></td>
		<td rowspan="2">
			選択できるソースの種類は次の２通り：
			<ul>
				<li>アクティブなインスタンスからクローンを作成する</li>
				<li>バックアップからクローンを作成する</li>
			</ul>
		</td>
		<td rowspan="3">
			ターゲットデータベースに対し、次のような情報を指定する
			<ul>
				<li>配置するコンパートメント</li>
				<li>DBのバージョン・コア数・ストレージサイズなどを含むスペック</li>
			</ul>
			ネットワークは、ソースデータベースと同一のVCN・サブネットに配置される
		</td>
	</tr>
	<tr>
		<td><div style="color:#c74634"><b>メタデータ・クローン</b></td>
	</tr>
	<tr>
		<td><div style="color:#c74634"><b>更新可能・クローン</b></td>
		<td>アクティブなインスタンスからクローンを作成することはできるが、バックアップからクローンを作成することはできない</td>
	</tr>
</table>
