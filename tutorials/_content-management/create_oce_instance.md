...
~~~
この文書は、2021年6月時点での最新バージョン(21.5.1)を元に作成されてます
~~~
...
1. 画面左の「コンパートメント」より、**OCE インスタンスを作成するコンパートメント** （ここでは **OCE** コンパートメント）を選択し、**「インスタンスの作成」** をクリックします

    ![OCEインスタンスの作成](019.webp)

1. **「インスタンス名」** と **「説明」** を入力し、**「インスタンスの作成」** をクリックします
...
- ルート・コンパートメントに ***OCE_Internal_Storage_Policy*** のポリシーが自動生成されます。ポリシーを確認するには、「アイデンティティとセキュリティ」→「ポリシー」で、ルート・コンパートメントを選択します
  ...
  - このポリシーは、OCEインスタンス利用中は削除しないでください
