...
2. 立ち上がった ”コンピュート・インスタンスの作成” ウィンドウに 以下の項目を入力し、**`作成`** ボタンを押下します
   ...
   - **ネットワーキングの構成**
     ...
     <img width="700" alt="img5.png" src="img5.png">
   ...
   - **SSHキーの追加** - "SSHキー・ペアの生成" を選択し、**`秘密キーの保存`**、**`公開キーの保存`** ボタンをそれぞれ押下します。秘密キー ”ssh-key-yyyy-MM-dd.key”、公開キー ”ssh-key-yyyy-MM-dd.key.pub” というファイルがそれぞれダウンロードされます。
     ...
     <img width="700" alt="img6.png" src="img6.png">
   ...
   - **ブート・ボリュームの構成**
     ...
     <img width="700" alt="img7.png" src="img7.png">
...
4. インスタンスの作成が完了すると、アイコンが黄色から緑色にかわり、ステータス表示が RUNNING に変わります。
...
1. 任意のターミナルソフトを起動し、以下の情報でssh接続します。
   ...
   <img width="450" alt="img14.png" src="img14.png">
