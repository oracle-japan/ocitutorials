...
| ブロック・ボリューム<br>NFSサーバ<br>(NFS) | **ベア・メタル・インスタンス**<br>+<br>**ブロック・ボリューム** | **BM.Optimized3.36**               | **ブロック・ボリューム**       | 中期保存<br>データ         | 5 GiB/s<br>（※5）        |
| DenceIO<br>NFSサーバ<br>(NFS)    | DenceIOタイプ<br>**ベア・メタル・インスタンス**          | **BM.DenseIO.E5.128**              | NVMe SSD<br>ローカルディスク | 短期保存<br>データ         | 10 GiB/s<br>（※5）       |
