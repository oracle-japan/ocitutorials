...
以降は、HPCワークロード向けベアメタルシェイプの **BM.Optimized3.36** にRocky Linux 9.1、CentOS 7.9、又はubuntu 20.04を、機械学習ワークロード向けベアメタルシェイプの **BM.GPU4.8/BM.GPU.A100-v2.8** にUbuntu 20.04を使用し、これらのインスタンスをクラスタ・ネットワークに接続する方法を解説します。
