...
(() => {
                                                        ...
                                                        value: function (t) {
                                                            var e = t.delegateTarget || t.currentTarget,
                                                                ...
                                                                o = (function () {
                                                                    ...
                                                                    return c ? d(c, { container: o }) : r ? ("cut" === n ? l(r) : d(r, { container: o })) : void 0;
    ...
    (() => {
        ...
        document.addEventListener("DOMContentLoaded", function () {
            new t(".clip").on("success", function (t) {
                const e = t.trigger;
                e.hasAttribute("data-copy-feedback") &&
                    ...
                    setTimeout(function () {
                        e.classList.remove("gdoc-post__codecopy--success", "gdoc-post__codecopy--out"), e.querySelector(".gdoc-icon.copy").classList.remove("hidden"), e.querySelector(".gdoc-icon.check").classList.add("hidden");
                    }, 3e3)),
                    t.clearSelection();
            }),
                document.querySelectorAll("pre").forEach((t) =>
                    (function (t) {
                        ...
                        let n = "pre > code";
                        t.querySelector(".lntable") && (n = ".lntable .lntd:last-child code");
                        ...
                        if (null !== o) {
                            ...
                            e.classList.add("flex", "align-center", "justify-center", "clip", "gdoc-post__codecopy"),
                                (e.type = "button"),
                                (e.innerHTML = '<svg class="gdoc-icon copy"><use xlink:href="#gdoc_copy"></use></svg><svg class="gdoc-icon check hidden"><use xlink:href="#gdoc_check"></use></svg>'),
