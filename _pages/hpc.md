...
現時点は、 **[マーケットプレース](#2-5-マーケットプレイス)** から無料で利用可能な **[スタック](#2-3-スタック)** を利用してブロック・ボリュームとベアメタルインスタンスからNFSでファイル共有ストレージ環境を自動構築するチュートリアル **[ブロック・ボリュームでNFSファイルサーバを構築する](/ocitutorials/hpc/spinup-nfs-server/)** を利用することが可能です。
