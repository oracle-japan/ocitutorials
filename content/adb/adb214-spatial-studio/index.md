...
description: "Oracle Spatialを使用すると、開発者は基本的な空間検索や分析から高度な地理空間アプリケーションや地理情報システム(GIS)まで、すべてのアプリケーションで空間分析を使用できます。"
weight: "3_214"
layout: single
header:
images:
- "adb/adb214-spatial-studio/tokyo_boundary_image.jpg"
tags:
- データベース
- アプリケーション開発
header:
