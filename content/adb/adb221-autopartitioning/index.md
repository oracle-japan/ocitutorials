...
description: "パーティショニングにはパフォーマンスを向上させたり、大規模な表の管理がしやすくなるというメリットがあります。自動パーティション化は表や索引を自動的にパーティション化することができる機能です。"
weight: "3_221"
layout: single
tags:
- データベース
- 運用管理・監視
images:
- "adb/adb221-autopartitioning/partitioningadvantage.png"
header:
