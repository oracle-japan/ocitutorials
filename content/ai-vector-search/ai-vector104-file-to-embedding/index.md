...
description: "23ai free、ADB23ai(Always Free)を利用してファイルからテキストへ、テキストからチャンクへ、チャンクからベクトルデータへの変換、およびベクトルの検索について紹介します。"
weight: "4_104"
layout: single
tags: 
  - データベース
  - AIと機械学習
images:
- ai-vector-search/ai-vector104-file-to-embedding/ai-vector104-file-to-embedding-teaser.png
