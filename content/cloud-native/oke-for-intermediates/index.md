...
「トークンおよびキー」を選択し、下にスクロールして「認証トークン」の項目にある、「トークンの生成」をクリックします。

![alt text](image-2.png)

以下の項目を入力し、「トークンの生成」をクリックします。
...
「サブスクリプション」をクリックし、「サブスクリプションの作成」をクリックします。
...
今回は"okehandson\_\_Oracle1234"としてパスワードを作成します。
...
今回は管理者パスワードと同じ"okehandson\_\_Oracle1234"としてパスワードを作成します。
...
「Oracle AI Database」メニューの「Autonomous AI Database」をクリックします。
...
| Password | ATPデータベースのパスワード。今回は"okehandson\_\_Oracle1234" | [3-2. ATPのプロビジョニング](#3-2-atpのプロビジョニング)で`kuebctl create secret`コマンドで作成した管理者パスワード |
...
| key        | value                    | 説明                                                                                                                |
| ---------- | ------------------------ | ------------------------------------------------------------------------------------------------------------------- |
| パスワード | okehandson\_\_Oracle1234 | [3-2. ATPのプロビジョニング](#3-2-atpのプロビジョニング)で`kuebctl create secret`コマンドで作成したWalletパスワード |
...
| 認証タイプ   | デフォルト                           |                                                                                                                     |
| ユーザ名     | admin                                |                                                                                                                     |
| パスワード   | okehandson\_\_Oracle1234             | [3-2. ATPのプロビジョニング](#3-2-atpのプロビジョニング)で`kuebctl create secret`コマンドで作成した管理者パスワード |
| 接続タイプ   | クラウド・ウォレット                 |                                                                                                                     |
