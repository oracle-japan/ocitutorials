...
- [Oracle Cloud で Oracle Database を使おう](../exadb-d101-create-exadb-d/) を通じて Oracle Database の作成が完了していること
...
![img](exadbd103-12.png)

作成が終わると、保護ポリシーが表示されます。

![img](exadbd103-13.png)

保護ポリシーの一覧を確認することもできます。

![img](exadbd103-14.png)
