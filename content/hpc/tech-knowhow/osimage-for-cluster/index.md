...
| No. | 対象シェイプ  | **Oracle Linux**<br>バージョン | ユーティリティ<br>提供方法      | OFED<br>バージョン | GPU/CUDA<br>バージョン | イメージOCID                                                                                      |
| :-: | :-----: | :-----------------------: | :------------------: | :-----------: | :---------------: | :----------------------------------------------------------------------------------------: |
| 5   | HPC | 8.7                       | 個別RPM                | 5.4           | -                 | ocid1.image.oc1..aaaaaaaaceagnur6krcfous5gxp2iwkv2teiqijbntbpwc4b3alxkzyqi25a                                             |
| 12  |         | 8.10                      | **OCA** HPC<br>プラグイン | 24.10         | -                 | ocid1.image.oc1..aaaaaaaa45plxi2fuhmbze63ynbs3xfigb2iroqpbqxh5qbauw3pbh66ddvq                        |
| 13  |         | 9.5                       | **OCA** HPC<br>プラグイン | 24.10         | -                 | ocid1.image.oc1..aaaaaaaaxtobh657yix7kj2zbbuzhwzgvlonqjhpqa23ixdlq2dwipeelxsa                         |
| 14  | GPU | 8.10                      | **OCA** HPC<br>プラグイン | 24.10         | 570/12.8          | ocid1.image.oc1..aaaaaaaas3btftybuhx6gm4o7t2t4bs776pn5dcpk4kgmtbzvynzjkhxoi2q |
| 15  |  | 9.5                       | **OCA** HPC<br>プラグイン | 24.10         | 570/12.8          | ocid1.image.oc1..aaaaaaaaevo5a2g6zd524mlu5aopkzxem6farzeilzqwcaax6nnpaflr2ipq |
...
OCIコンソールを使用して **[クラスタ・ネットワーク](../../#5-1-クラスタネットワーク)** に接続するインスタンスを作成する場合、 **[インスタンス構成](../../#5-7-インスタンス構成)** を予め作成しますが、この **インスタンス構成** の **イメージとシェイプ** フィールドで **[クラスタネットワーキングイメージ](../../#5-13-クラスタネットワーキングイメージ)** を選択します。

以下 **イメージの選択** サイドバーで、 **My Images** を選択して表示される **イメージOCID** を選択して表示される **イメージOCID** フィールドに選択した **クラスタネットワーキングイメージ** のOCIDを **[1. クラスタネットワーキングイメージ一覧](#1-クラスタネットワーキングイメージ一覧)** の **イメージOCID** 列を参照して入力し、 **イメージの選択** ボタンをクリックします。
