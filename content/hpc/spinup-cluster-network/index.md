...
3. **イメージとシェイプ** フィールド
    ...
    - **イメージ** ： **Oracle-Linux-8.10-2025.06.17-0-RHCK-OFED-24.10-1.1.4.0-2025.07.19-0** / **Oracle-Linux-9.5-2025.05.19-0-RHCK-OFED-24.10-1.1.4.0-2025.07.20-0** （※3）  
    ※3）このイメージは、 **[OCI HPCテクニカルTips集](../#3-oci-hpcテクニカルtips集)** の **[クラスタネットワーキングイメージの選び方](../tech-knowhow/osimage-for-cluster/)** の **[1. クラスタネットワーキングイメージ一覧](../tech-knowhow/osimage-for-cluster/#1-クラスタネットワーキングイメージ一覧)** のイメージ **No.12** / **No.13**で、 **[2-1. OCIコンソールを使用する方法](../tech-knowhow/osimage-for-cluster/#2-1-ociコンソールを使用する方法)** の手順に従い指定します。
